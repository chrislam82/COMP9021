...
# Created time 14/3/2019
	# So I skipped 12 because my code is shit... (I think you need truth tables to do it in less than a min, if not then a lot of mins)
	# NOTE: test_50.txt runs twice, with solutions replaced with solution so we can confirm tests running properly and see how many tests run
...
# Skipped because too large and my code is shit
